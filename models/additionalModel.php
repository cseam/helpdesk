<?php
  ...
  public function __construct()
    ...
    public function countFieldsByCategoryId($categoryid) {
      $database = new Database();
      $database->query("SELECT COUNT(*) as count FROM call_additional_fields WHERE typeid = :typeid");
      $database->bind(":typeid", $categoryid);
    ...
    public function addAdditionalResult($callid, $label, $value) {
      $database = new Database();
      $database->query("INSERT INTO call_additional_results (callid, label, value) VALUES (:callid , :label, :value)");
