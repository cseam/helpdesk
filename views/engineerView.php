<?php require_once "views/partials/header.php"; ?>
  ...
  <div id="leftpage">
    ...
    <div id="engineerControls" class="engineersubnav">
      ...
      <div id="objlist" class="engineerReports"><?php ($objdata ? include "views/partials/myobjectives.php" : print("<h3>Performance Objectives</h3><p>0 performance objectives set</p>")) ?></div>
