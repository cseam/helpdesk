      ...
      <div id="ajax">
        ...
        <p>
          <form action="#" method="post" id="addForm">
            ...
            <button name="add" value="add" type="submit" onclick="this.form.button_value.value = this.value;">Add New Quick Response</button>
          </form>
        </p>
        <table>
        <thead>
        ...
        <tbody>
        <?php
          if (isset($pagedata->listofQuickresponses)) {
              foreach ($pagedata->listofQuickresponses as $key => $value) { ?>
                <tr>
                  <td><?php echo $value["quick_response"]; ?></td>
