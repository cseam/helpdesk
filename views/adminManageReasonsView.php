      ...
      <div id="ajax">
        ...
        <p>
          <form action="#" method="post" id="addForm">
            ...
            <button name="add" value="add" type="submit" onclick="this.form.button_value.value = this.value;">Add New Reason</button>
          </form>
        </p>
        <table>
        <thead>
        ...
        <tbody>
        <?php
          if (isset($pagedata->listofreasons)) {
              foreach ($pagedata->listofreasons as $key => $value) { ?>
                <tr>
                  <td><?php echo $value["reason_name"]; ?></td>
