<div id="reportlinks">
  <!-- generic reports -->
  <a href="/report/engineerbreakdown/"><img src="/public/images/ICONS-yourcalls.svg" alt="Engineer Breakdown" title="Engineer Breakdown" width="24" height="25" />Engineer Breakdown</a>
...
<?php if ($_SESSION['engineerLevel'] > 1 || $_SESSION['superuser'] == 1) { ?>
