...
<div style="float:right;margin-top: -20px;margin-right: 8px;">
  <span style="font-size: 0.6rem;color: white;background: #BFCC80;padding: 0.1rem 0.5rem;"><?php echo "Total tickets closed in ".date("Y",strtotime("-1 year"));?></span>
  <span style="font-size: 0.6rem;color: white;background: #FFA38B;padding: 0.1rem 0.5rem;"><?php echo "Total ticket closed in ".date("Y") ;?></span>
</div>
