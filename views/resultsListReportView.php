      ...
      <div id="ajax">
        ...
        <table id="yourcalls">
          <tbody>
            ...
            <tr>
              <td class="hdtitle listheader" colspan="7"><a href="/ticket/view/<?php echo $value["callid"] ?>" alt="view ticket"><?php echo $value["title"] ?></a></td>
            </tr>
            <?php if (isset($value["requiredfor"])) { ?>
              <tr><td class="hdtitle" colspan="7"><?php echo $value["requiredfor"] ?></td></tr>
            <?php } ?>
            <tr>
              <td><?php if ($value["userupdate"] === '0') { ?><span class="status6" title="Ticket updated by user">Updated</span><?php } ?></td>
