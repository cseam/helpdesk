      ...
      <div id="ajax">
        ...
        <p>
          <form action="#" method="post" id="addForm">
            ...
            <button name="add" value="add" type="submit" onclick="this.form.button_value.value = this.value;">Add New Category</button>
          </form>
        </p>
        <table>
        <thead>
        ...
        <tbody>
        <?php
          if (isset($pagedata->listofcategorys)) {
              foreach ($pagedata->listofcategorys as $key => $value) { ?>
                <tr>
