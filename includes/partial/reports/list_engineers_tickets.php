...
<p class="engineersubnav">
	<a href="#" onclick="update_div('#engineerscallview','reports/list_assigned_tickets.php');"><img src="/public/images/ICONS-yourcalls@2x.png" alt="your tickets" title="your tickets"  width="16" height="17" /> Assigned Tickets</a>
	...
	<a href="#" onclick="update_div('#engineerscallview','reports/null.php');"><img src="/public/images/ICONS-allcalls@2x.png" alt="Performance Objectives" title="Performance Objectives"  width="16" height="17" /> Performance Objectives</a>
