...
<p class="engineersubnav">
	...
	<a href="#" onclick="update_div('#engineerscallview','reports/list_my_performance_objectives.php');"><img src="/public/images/ICONS-allcalls@2x.png" alt="Performance Objectives" title="Performance Objectives"  width="16" height="17" /> Objectives</a>
