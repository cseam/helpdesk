<?php
	...
	if($_POST['status']) { echo ("status:".$_POST['status']); };
	if($_POST['helpdesk']) { echo ("helpdesk:".$_POST['helpdesk']); };
	if($_POST['engineer']) { echo ("engineer:".$_POST['engineer']); };
	if($_POST['location']) { echo ("location:".$_POST['location']); };
